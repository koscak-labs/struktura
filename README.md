...
pip install struktura --find-links https://github.com/koscak-labs/struktura/releases/expanded_assets/py-v1.8.5
...
npm install https://github.com/koscak-labs/struktura/releases/download/wasm-v1.8.5/struktura-1.8.5.tgz
