pub fn generate_c_monitor(window_size: usize, threshold: f64) -> String {
    ...
    let (sizes, count) = crate::dfa_box_sizes(window_size);
...
#define DFA_NUM_BOXES   {num_boxes}
...
"#, window = window_size, threshold = threshold, num_boxes = count,
        box_slots = count.max(1), boxes = boxes)
}
